...
export class ShopAdminControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getShopSettingsUsingGET(id: string, observe?: 'body', reportProgress?: boolean): Observable<ShopAdminDto>;
    public getShopSettingsUsingGET(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ShopAdminDto>>;
    public getShopSettingsUsingGET(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ShopAdminDto>>;
    public getShopSettingsUsingGET(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getShopSettingsUsingGET.');
        }
        ...
        return this.httpClient.request<ShopAdminDto>('get',`${this.basePath}/api/admin/shop/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
