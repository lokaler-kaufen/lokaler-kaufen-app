...
export class ShopControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getShopSettingsUsingGET1(observe?: 'body', reportProgress?: boolean): Observable<ShopOwnerDetailDto>;
    public getShopSettingsUsingGET1(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ShopOwnerDetailDto>>;
    public getShopSettingsUsingGET1(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ShopOwnerDetailDto>>;
    public getShopSettingsUsingGET1(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
