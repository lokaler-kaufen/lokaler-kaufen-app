...
export class ReservationControllerService {
    ...
    public getExistingReservationsUsingGET(shopId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ReservationDto>>('get',`${this.basePath}/api/reservation/${encodeURIComponent(String(shopId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getSlotsForShopUsingGET(shopId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<SlotDto>>('get',`${this.basePath}/api/reservation/${encodeURIComponent(String(shopId))}/slots`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
